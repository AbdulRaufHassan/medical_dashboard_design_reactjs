    ...
    <header className="w-full h-auto">
      <div className="w-full flex items-center justify-between h-auto py-4 px-3 primaryBgColor">
        <div className="flex items-center gap-5">
          ...
          <input
            type="text"
            className="w-72 py-[18px] px-[15px] bg-[#f4f4f4] text-lg font-normal text-[#b8b7b7] rounded-lg placeholder:text-[#b8b7b7] focus:outline-none"
            placeholder="Search"
          />
        </div>
        <div className="flex items-center">
          <div className="flex items-center gap-6">
            ...
            <button className="relative mr-3 ml-3">
            ...
            <button className="relative mt-1 ml-3 mr-3">
